...
public class ControlInputProcessor {
	...
	public ControlInputProcessor(BMSPlayer player, BMSPlayerMode autoplay) {
		...
		case BEAT_10K:
			...
			break;
		case GENERIC_4K:
			processStart = () -> processStartG4key();
			processSelect = () -> processSelectG4key();
			break;
		case GENERIC_6K:
			processStart = () -> processStartG6key();
			processSelect = () -> processSelectG6key();
			break;
		default:
